function [f,g,D]=MAhpcFS(gamma,n,nbar,na,NN,NNbar,NNrep,minNind,maxNind,maxN,Kbar,K1,Cbar,betaS,betaI,betaD,beta3,isdual,solvetype,numseed)%,eps)
%ZfinalSizeAllMulti2
