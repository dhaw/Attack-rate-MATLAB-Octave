function [f,g]=epiRP(gamma,NN,n,K,L,Vi,Viover,beta,kangle,h,w,rhohat,isflat,numseed,sample,boxLat,boxLong,loc)
%mu=0;%In ODE code
t0=0; tend=360;
plotto=tend;
logplotmin=-4;
...
[f,g]=XODEsolveAllMulti(gamma,NN,n,L,beta,Z0,t0,tend,zn,phi1,phi2,seed,alpha,seedvec,plotto,sample,logplotmin,plotmin,plotmax,logplot,incidence,plotfig);
%{
